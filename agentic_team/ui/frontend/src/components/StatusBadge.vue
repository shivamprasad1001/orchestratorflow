<template>
  <span :class="['status-badge', `status-${status}`, theme === 'cyan' ? 'theme-cyan' : '']">
...
/* Cyan theme idle */
.theme-cyan.status-idle {
  background-color: rgba(8, 51, 68, 0.5);
  color: #67e8f9;
  border-color: rgba(34, 211, 238, 0.2);
}
.theme-cyan.status-idle .badge-dot {
...
/* Cyan theme running */
.theme-cyan.status-running {
  background-color: rgba(8, 145, 178, 0.2);
  color: #22d3ee;
  border-color: rgba(34, 211, 238, 0.4);
  box-shadow: 0 0 12px rgba(34, 211, 238, 0.25);
}
.theme-cyan.status-running .badge-dot {
...
/* Cyan theme completed */
.theme-cyan.status-completed {
  background-color: rgba(13, 148, 136, 0.25);
  color: #5eead4;
  border-color: rgba(45, 212, 191, 0.35);
  box-shadow: 0 0 10px rgba(45, 212, 191, 0.2);
}
.theme-cyan.status-completed .badge-dot {
...
/* Cyan theme error */
.theme-cyan.status-error,
.theme-cyan.status-failed {
  background-color: rgba(159, 18, 57, 0.3);
  color: #fda4af;
  border-color: rgba(251, 113, 133, 0.35);
  box-shadow: 0 0 8px rgba(251, 113, 133, 0.15);
}
.theme-cyan.status-error .badge-dot,
.theme-cyan.status-failed .badge-dot {
