...
class GroqAdapter(BaseAdapter):
    ...
    def execute_task(self, task: str, context: Dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            # Fallback if loop is already running (unlikely in this CLI context)
    ...
    def _execute_sync(self, task: str, context: Dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            self.logger.error("Groq execution failed: %s", e)
    ...
    async def execute_task_async(self, task: str, context: Dict[str, Any]) -> AgentResponse:
        ...
        try:
            ...
            self.logger.error("Groq async execution failed: %s", e)
            return AgentResponse(success=False, output="", error=str(e))
